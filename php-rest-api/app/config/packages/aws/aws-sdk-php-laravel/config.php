...
return array(
    ...
    |
    */
    //Master keys for Server side usage
    /*
     * Old keys: Back up for case of reversion
     * 'key'    => 'AKIAITJ4QNAG77IZCF4Q',
     * 'secret' => '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',
     */
    'key'    => $_ENV['AWS_USER_SERVER_ID'],
    'secret' => $_ENV['AWS_USER_SERVER_KEY'],

    //Key pair for Client side usage
    'clientAccessKey' => $_ENV['AWS_USER_CLIENT_ID'],
    'clientSecretKey' => $_ENV['AWS_USER_CLIENT_KEY'],

    //Buckets
	'bucket'         => "rci-{region}-processed-receipts",
    'bucketManual'   => "manualReceipt",
    'bucketFile'     => "rci-{region}-attachments",
    'bucketMerchant' => $_ENV['AWS_BUCKET_MERCHANT'],

    'SQS' => array(
        'region' => "us-west-2",
        'originalQueue' => "USW2-OriginalReceiptsQueue",
        'processedQueue' => "USW2-ProcessedReceiptsQueue",
