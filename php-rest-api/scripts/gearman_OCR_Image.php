...
function writeLog ($content) {
    $file 	  = dirname(__FILE__) . '/sy_log.txt';
...
if (isset($argv[5])) {
    ...
    do {
        try {
            ...
            if ($ftype == 'PDF') {
                $msg = $client->doNormal('ImageProcessing_PDF_S3', json_encode(array('imageName' => $keyName)));
            } else {
                $msg = $client->doNormal('ImageProcessing_IMG_S3', json_encode(array('imageName' => $keyName)));
            }
